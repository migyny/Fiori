...
| Test Action  | Result |
| ------------- | ------------- |
| Access the page and be ready to navigate to the tabs to ensure functionality  | Users can successfully navigate between the main pages of the website.  |
| User must click on each of the pictures with corresponding flowers to make sure the website loads the images and information  | Test user can access all of the information and requested flowers  |
| The user must be able to pull the requested information and the rating system must be tracked and work | Users can click on any product to view its detailed information, including image, description, and price, and can interact with the rating system. |
